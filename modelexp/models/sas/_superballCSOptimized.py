...
from fortSAS import superball_new_cs

from numpy.polynomial.hermite import hermgauss
from numpy.polynomial.legendre import leggauss

class SuperballCSOptimized(SAXSModel):
  def initParameters(self):
    self.params.add('r', 100)
    self.params.add('d', 15)
    self.params.add('pVal', 2.3)
    self.params.add('sldCore', 40e-6)
    self.params.add('sldShell', 10e-6)
  ...
  def initMagneticParameters(self):
    ...
    self.params.add('magSldShell', 0e-6, min=0)
  ...
  def calcModel(self):
    ...
    self.r, self.sld = superball_new_cs.sld(
      self.params['r'],
      self.params['d'],
      self.params['sldCore'],
      self.params['sldShell'],
  ...
  def calcMagneticModel(self):
    ...
    self.rMag, self.sldMag = superball_new_cs.sld(
      self.params['r'],
      self.params['magSldCore'],
      self.params['magSldSolvent'],
    )
