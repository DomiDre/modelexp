...
class SphereCSStackedLinearSpacer(ReflectometryModel):
  '''
  ...
  def calcModel(self):
    if (self.z is not None):
      roughness = self.params["roughness"] + self.z*self.params["roughnessSlope"]

      sld = nanospheres.sphere_csstacked_linear_with_spacer(
        self.z,
