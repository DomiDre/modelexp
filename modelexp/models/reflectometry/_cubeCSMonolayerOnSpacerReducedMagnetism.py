...
class CubeCSMonolayerOnSpacerReducedMagnetism(ReflectometryModel):
  '''
  ...
  def initMagneticParameters(self):
    ...
    self.params.add("dReduced1", 10, min = 0, max = 100, vary = True)
    self.params.add("dReduced2", 10, min = 0, max = 100, vary = True)
    self.params.add("magSldReduced1", 0.1e-6, min = 0, max = 3e-6, vary = True)
    self.params.add("magSldReduced2", 0.1e-6, min = 0, max = 3e-6, vary = True)
  ...
  def calcMagneticModel(self):
    a = self.params['a'].value
    dReduced1 = self.params['dReduced1'].value
    dReduced2 = self.params['dReduced2'].value
    magSldReduced1 = self.params['magSldReduced1'].value
    magSldReduced2 = self.params['magSldReduced2'].value
    ...
    sldMag = np.array([
      ...
      0,
      0,
      pDens * magSldReduced1,
      pDens * self.params['magSldCore'].value,
      pDens * magSldReduced2,
      0,
      0,
    ])
