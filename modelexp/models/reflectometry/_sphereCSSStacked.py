  ...
  def calcModel(self):
    if (self.z is not None):
      ...
      sld = nanospheres.sphere_css_overlapping_stacked_with_spacer(
        ...
        self.params['r'].value, self.params['sigR'].value, self.params['dShell'].value,
        self.params['dSurfactant'].value, self.params['dSpacer'].value,
        self.params['sldCore'].value, self.params['sldShell'].value,
        self.params['sldSurfactant'].value, self.params['sldSpacer'].value,
        self.params['sldSubstrate'].value, self.params['sldBackground'].value)
